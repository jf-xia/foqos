...
struct ProfileWidgetEntryView: View {
  ...
  private var linkToOpen: URL {
    ...
    if entry.isBreakActive || entry.isSessionActive {
      return URL(string: "https://Zb.app")!
    }

    return entry.deepLinkURL ?? URL(string: "Zb://")!
  }
...
#Preview(as: .systemSmall) {
  ...
  ProfileWidgetEntry(
    ...
    deepLinkURL: URL(string: "https://Zb.app/profile/test-id"),
  ...
  ProfileWidgetEntry(
    ...
    deepLinkURL: URL(string: "https://Zb.app/profile/\(activeProfileId.uuidString)"),
  ...
  ProfileWidgetEntry(
    ...
    deepLinkURL: URL(string: "https://Zb.app/profile/\(breakProfileId.uuidString)"),
  ...
  ProfileWidgetEntry(
    ...
    deepLinkURL: URL(string: "https://Zb.app/profile/\(unavailableProfileId.uuidString)"),
